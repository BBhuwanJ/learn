...
export default function Day1Content({ theme, toggleTheme }: Day1ContentProps) {
    return (
...
if __name__ == '__main__':
  ...
  -d '{"title":"Updated","content":"New content"}'`}</code>
                ...
                <div className="mb-8">
                    <h2 className="text-2xl font-bold text-purple-700 dark:text-purple-400 mb-6">💻 Interactive Python Practice</h2>
                    <p className="text-gray-700 dark:text-gray-300 mb-4">
                        Try out Python code right here! You can install Flask and create a complete project structure.
                    </p>
                    ...
                    <CodePlayground
                        ...
                        initialCode={`# Welcome to Day 1 Practice!
# First, install Flask using the package installer above
# Then try creating a simple Flask route
...
# Sample data
notes = [
    {"id": 1, "title": "First Note", "content": "Hello Flask!"}
]
...
`}
                    ...
                    <div className="mt-4 bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-600 p-4 rounded-r-lg">
                        <p className="font-semibold text-gray-800 dark:text-gray-200 mb-2">💡 Try These Exercises:</p>
                        <ol className="list-decimal list-inside space-y-1 text-gray-700 dark:text-gray-300 text-sm">
                            <li>Install Flask using the package installer (type &quot;flask&quot; and click Install)</li>
                            <li>Create multiple files using the Explorer sidebar: models.py, config.py, utils.py</li>
                            <li>Create a function that adds a new note to the list</li>
                            <li>Implement a function to update an existing note</li>
                            <li>Write a function that filters notes by keyword in title</li>
                            <li>Practice working with JSON using jsonify()</li>
                        </ol>
                    </div>

                    <div className="mt-4 bg-green-50 dark:bg-green-900/20 border-l-4 border-green-600 p-4 rounded-r-lg">
                        <p className="font-semibold text-gray-800 dark:text-gray-200 mb-2">🎯 How to Build a Complete Flask Project:</p>
                        <div className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                            <p><strong>Step 1:</strong> Click the package installer and type <code className="bg-gray-200 dark:bg-gray-800 px-2 py-0.5 rounded">flask</code> to install Flask</p>
                            <p><strong>Step 2:</strong> Use the Explorer sidebar on the left to view your project files</p>
                            <p><strong>Step 3:</strong> Click the &quot;+&quot; button in the Explorer to create additional files like:</p>
                            <ul className="list-disc list-inside ml-4 space-y-1">
                                <li><code className="bg-gray-200 dark:bg-gray-800 px-2 py-0.5 rounded">models.py</code> - for data models</li>
                                <li><code className="bg-gray-200 dark:bg-gray-800 px-2 py-0.5 rounded">config.py</code> - for configuration</li>
                                <li><code className="bg-gray-200 dark:bg-gray-800 px-2 py-0.5 rounded">utils.py</code> - for helper functions</li>
                            </ul>
                            <p><strong>Step 4:</strong> Click on any file in the Explorer to edit it, then click ▶ Run Code to execute</p>
                            <p className="mt-2 text-xs italic">💡 The file tree stays visible on the left just like VS Code!</p>
                        </div>
                    </div>
                </div>
